            ...
            <div className="grid md:grid-cols-2 gap-10">
              <div>
                ...
                <p className="text-[var(--text-secondary)] mb-8">
                  I'm currently available for freelance work and open to discussing new projects. Feel free to reach out through the form or connect with me on social media.
                </p>
